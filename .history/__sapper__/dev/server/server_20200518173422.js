...
async function getPosts() {
	const files = await fs.promises.readdir('src/bposts');
	...
	for (const file of files) {
		...
		posts.push(matter(file));
	}

	console.log(`Theese are posts: ${posts}`);
	return posts
}
console.log(getPosts());
const allPosts = getPosts();

const contents = JSON.stringify(await allPosts.map(post => {
	return {
		title: post.title,
		slug: post.slug
	};
